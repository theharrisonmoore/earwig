...
//     const hasCanteen = getAverage(canteenHeader[0].answers);

//     const { moreYes, dontKnow } = hasCanteen;

//     console.log("has canteen", hasCanteen);

//     return (
//       <ListWrapper>
//         {moreYes ? (
//           <>
//             <CanteenItem itemAvailable={moreYes}>
//               <Icon
//                 icon="canteen"
//                 margin="0 1rem 0 0"
