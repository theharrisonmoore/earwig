  ...
  render() {
    ...
    return (
      <Wrapper isMobile={isMobile}>
        ...
        {isLoggedIn ? (
          <>
        <PriorityMenuItem to={isWorker ? GIVE_REVIEW_URL : PROFILE_URL} onClick={toggleMenu}>
        ...
        <PriorityMenuItem disabled to={isWorker? ASK_QUESTION_URL : PROFILE_URL} onClick={toggleMenu}>
        ...
        {isWorker && <PriorityMenuItem  disabled to={JOBS_URL} onClick={toggleMenu}>
          <PriorityIcon disabled icon="jobBoard" height="19" width="19" />
          <ComingSoon><p>Find a job</p> <span>(coming soon)</span></ComingSoon>
        </PriorityMenuItem>}
        {isWorker && <PriorityMenuItem to={INVITE_WORKERS_URL} onClick={toggleMenu}>
        ...
        {isWorker &&<MenuItem disabled to={PROFILE_URL} onClick={toggleMenu}>
          <MenuIcon disabled icon="email" height="19" width="19" />
          <ComingSoon purple><p>Your inbox</p> <span>(coming soon)</span></ComingSoon>
        </MenuItem>}
        {isWorker && <MenuItem to={MY_REVIEWS_URL} onClick={toggleMenu}>
        ...
        {isWorker && <MenuItem to={RESOURCES_URL} onClick={toggleMenu}>
