...
const ADD_COMMENT_ON_OVERALL_REVIEW_URL = "/reviews/overall/replies";
const API_ADD_COMMENT_ON_OVERALL_REVIEW_URL = `${API_PREFIX}${ADD_COMMENT_ON_OVERALL_REVIEW_URL}`;
...
module.exports = {
  ...
  ADD_COMMENT_ON_OVERALL_REVIEW_URL
};
