...
module.exports.checkOrgExists = organizationID =>
...
module.exports.addCommentOnOverallReview = (id, data, target) =>
...
module.exports.approveRejectReview = (id, bool) =>
  Review.findOneAndUpdate({ _id: id }, { isVerified: bool }, { new: true });
...
module.exports.overallReview = organizationID =>
...
module.exports.basicReview = organizationID =>
  Organization.aggregate([
    // get the specific organization
    {
      $match: { _id: mongoose.Types.ObjectId(organizationID) }
...
module.exports.allAnswers = organizationID =>
  new Promise((resolve, reject) => {
    Answer.aggregate([
...
module.exports.allQsAndAs = (orgType, orgId, justContractor) =>
  new Promise((resolve, reject) => {
    let match = {
...
module.exports.allComments = (organizationID, questionID) =>
  new Promise((resolve, reject) => {
    Comment.aggregate([
      {
        $match: {
...
module.exports.checkUsersLatestReview = (organization, user) =>
  new Promise((resolve, reject) => {
    Review.aggregate([
 ...
 * @return {query}
 */
module.exports.patchReviewField = (reviewId, data) =>
  Review.findByIdAndUpdate(reviewId, { $set: data }, { omitUndefined: true });
...
module.exports.getOneReviewWithOrgAndUser = reviewId =>
  Review.findById(reviewId)
    .populate({ path: "user", select: "email" })
    .populate({ path: "organization", select: "category name" });

module.exports.getOrgsReviewedLast30D = userId =>
  Review.find(
    {
      $and: [
